...
export default {
    ...
    created() {  
        this.axios.get(`http://localhost:81/api_perpus/public/api/siswa/${this.$route.params.id}`, { headers : {'Authorization' : `Bearer` + this.$store.state.token} })
                  .then((res) => {
                      this.siswa = res.data
                  })
    ...
    methods : {
        edit() {
            this.axios.put(`http://localhost:81/api_perpus/public/api/update_siswa/${this.$route.params.id}`, this.siswa, { headers : {'Authorization' : `Bearer` + this.$store.state.token} })
                      .then( () => {
